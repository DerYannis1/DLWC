...
class SimpleWeatherCNN(pl.LightningModule):
    def __init__(self, in_channels=35, out_channels=35):
        ...
        self.conv2 = nn.Conv2d(200,       480, kernel_size=3, padding=1)
        self.bn2   = nn.BatchNorm2d(480)
        self.conv3 = nn.Conv2d(480,       480, kernel_size=3, padding=1)
        self.bn3   = nn.BatchNorm2d(480)
        self.conv4 = nn.Conv2d(480,       200, kernel_size=3, padding=1)
        self.bn4   = nn.BatchNorm2d(200)
        self.conv5 = nn.Conv2d(200,       120, kernel_size=3, padding=1)
        self.bn5   = nn.BatchNorm2d(120)
        self.conv6 = nn.Conv2d(120, out_channels, kernel_size=1)
