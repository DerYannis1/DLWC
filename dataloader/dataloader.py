...
def collate_fn_train(
    ...
    out = torch.stack([item[1] for item in batch])               # [B, V, H, W] (absolute t+1)
    ...
    variables = batch[0][5]                                      # List[str], same for all
...
class DLWCDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.out_transforms = {
            3: transforms.Normalize(normalize_mean, normalize_std)
        }
